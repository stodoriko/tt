...
//    -----------------------------------------------
//    git reset --mixed HEAD^^ или вариант по-умолчанию git reset HEAD^^
...
//
//    При вызове без указания желаемого коммита по-умолчанию используется HEAD (git reset = git reset --mexed HEAD)
